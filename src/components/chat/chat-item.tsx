...
import { Member, Profile } from "@/app/generated/prisma/client";
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md mt-2 overflow-hidden border flex items-center bg-secondary h-32 w-32"
            >
              <Image
                src={fileUrl!}
                alt={content}
